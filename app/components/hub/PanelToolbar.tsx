...
interface PanelToolbarProps {
	/** Primary AI action button (Scan Item for Cargo, Generate Meal for Galley) */
	primaryAction?: ReactNode;
	/** Secondary action button (+ New Meal, etc.) */
...
/**
 * Unified toolbar component for hub panels (Cargo, Galley).
