...
export function ConfirmDialog() {
	...
	return (
		...
		<dialog
			...
			className="w-full max-w-md p-0 rounded-2xl border border-platinum dark:border-white/10 bg-ceramic dark:bg-[#1A1A1A] shadow-xl backdrop:bg-carbon/30 backdrop:backdrop-blur-sm open:animate-fade-in [&::backdrop]:animate-fade-in"
