...
import { runNutritionRecomputeConsumerJob } from "~/lib/nutrition/recompute-consumer.server";
...
export const AI_QUEUE_HANDLERS: Record<string, QueueHandler> = {
	...
	"ration-nutrition-recompute":
		runNutritionRecomputeConsumerJob as QueueHandler,
	"ration-nutrition-recompute-dev":
		runNutritionRecomputeConsumerJob as QueueHandler,
	"ration-nutrition-recompute-local":
		runNutritionRecomputeConsumerJob as QueueHandler,
};
