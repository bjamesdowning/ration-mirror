...
/**
 * Max nutrition_intake rows per INSERT (v2 Eat path).
 * Columns bound when set explicitly on the canonical Eat insert: id,
 * organizationId, userId, planId, entryId, mealId, organizationNameSnapshot,
 * mealNameSnapshot, manifestDate, slotType, servings, energyKcal, proteinG,
 * carbsG, fatG, coverage, source, confidence, verified, occurredAt,
 * kitchenEventId, schemaVersion, nutrientsJson, coverageJson, fiberG,
 * consentId, idempotencyKey, operationId, replacesIntakeId, voidOperationId,
 * voidedAt, voidedByUserId, notes, createdAt = 34.
 */
export const NUTRITION_INTAKE_INSERT_COLUMNS = 34;
