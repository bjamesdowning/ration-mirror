# Switching groups (organizations)

## Why groups exist

Each **organization** has its own Cargo, Galley, Manifest, Supply list, and **credit balance**. That lets you keep a **personal** pantry separate from a **household** or **team** workspace.

## Selecting the active group

Use the **group switcher** in the hub (exact placement is in the app chrome) to choose which organization is **active**. All hub pages—Cargo, Galley, Manifest, Supply, Settings actions—apply to that active group only.
