...
- **URL import** — Import a recipe from an HTTPS page, social post, or photo into Galley. Cost: see *Import a recipe (URL, social, or photo)* and *AI credits explained* (typically **3 credits**).
