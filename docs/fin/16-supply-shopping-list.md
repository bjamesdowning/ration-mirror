...
**Supply** lists what you still need to buy to cook your **selected** Galley meals and your **Manifest** week, compared against **Cargo**. Quantities can respect your **unit preference** (metric, imperial, or cooking-oriented display—configured in Settings where available).
