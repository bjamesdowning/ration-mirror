...
This guide explains how to use Ration. **Ask Ration** searches the same articles. Prefer the in-app screens when a detail differs from this text.

Browse topics below, or open Ask Ration from the hub for the same answers with live account context.
...
- [Ask Ration vs reading the guide](./06-ask-ration-vs-reading-docs.md) — Same source of truth for Copilot and self-serve reading.
...
- [Security overview](./40-security-overview.md) — Auth, isolation, rate limits, and Copilot posture.
- [Data, privacy, and deletion](./41-data-and-privacy.md) — Where legal policies live and what purge removes.
- [API key safety](./42-api-key-safety.md) — OAuth vs keys, rotation, and storage hygiene.

## Architecture and limits

- [Architecture at a glance](./50-architecture-at-a-glance.md) — D1, R2, KV, and Vectorize in plain language.
- [Async jobs and reliability](./51-reliability-and-async-jobs.md) — Queues, refunds, and idempotent AI jobs.
- [Limits and rate limits](./52-limits-and-rate-limits.md) — Tier caps and web/MCP throttles.
...
Full Terms and Privacy live on the site: [/legal/terms](/legal/terms) and [/legal/privacy](/legal/privacy).
