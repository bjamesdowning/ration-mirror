...
|------|-----------------|----------|-------------------|
| [01-what-is-ration.md](./01-what-is-ration.md) | What is Ration? | Both | What is Ration? What does Ration do? Does it track macros? Is Ration a meal kit? Can teams share a pantry? What is Ask Ration / Copilot? What is MCP? |
| [02-key-concepts.md](./02-key-concepts.md) | Key concepts: Cargo, Galley, Manifest, Supply | Both | What is Cargo vs Galley? What is Macro Tracking / Daily Fuel? Where do credits live? What is an organization? |
...
| [13-add-meals-url-import.md](./13-add-meals-url-import.md) | Import a recipe (URL, social, or photo) | Support | Can I import from a website? TikTok / Instagram / YouTube? Photo? What is a holder or skeleton? How much does import cost (3 credits)? |
...
| [25-nutrition-goals-and-tracking.md](./25-nutrition-goals-and-tracking.md) | Macro tracking, goals, and intake | Support | How do I set calorie goals? What is plate-up / Eat? Servings vs weighed g/oz? How long is intake kept? |
...
| [33-mcp-vs-web-app.md](./33-mcp-vs-web-app.md) | MCP vs hub app capabilities | Support | Can I scan receipts via MCP? Is plan week in MCP? Is URL import on iOS? |
