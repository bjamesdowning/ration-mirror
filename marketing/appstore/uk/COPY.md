...
## Companion fields (not localised copy)
...
See [`plans/app-review-notes.md`](../../../plans/app-review-notes.md). Demo account: `app-review@mayutic.com` (password from Wrangler `APP_REVIEW_DEMO_PASSWORD` / ASC Review Information).
